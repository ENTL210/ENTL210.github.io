...
export default function NavBar(props) {
    ...
    return (
        <div className="nav">
            ...
            <NavBtn state={blogState} onClick={event => {setHomeState(false); setBlogState(true); props.setIndex(1); setTimeout(function() {props.setIndex(0); setBlogState(false); setHomeState(true)}, 1000)}}>Blogs</NavBtn>
